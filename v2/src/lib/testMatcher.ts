...
export const TEST_ALIASES: Record<string, string[]> = {
  ...
  growth45: ['growth 45', 'growth45', '45c', '45 c', 'growth at 45c', 'growth 45°c'],
  ppr: ['ppr', 'ppr test', 'ppr agar', 'granada', 'granada agar'],
  growth_42: ['growth 42', 'growth42', '42c', '42 c', 'growth 42°c', 'growth on 42°c'],
  growth42: ['growth 42', 'growth42', '42c', '42 c', 'growth 42°c', 'growth on 42°c'],
